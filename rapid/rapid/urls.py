...
############# REST API calls ################
    ...
    url(r'^rapid/geoserver/layers/$', 'getGeoserverLayers'),
    url(r'^rapid/geoserver/geoviews/$', 'getGeoserverGeoviews'),
    url(r'^rapid/geoview/(?P<geo_uid>[\w]+)/features/$', 'getFeaturesInGeoview')
                       )